     ...
     <div className="row">
        ...
        <div className=" col-md-4 text-center">
            ...
            <div className="col-md-8">
             <p><a className="icon-color" href={ErikaMoyaResume}  onClick={notify}>
               ...
               <div className="col-md-3">
                <p> <a className="icon-color" href="https://www.linkedin.com/in/erika-moya-82a608165/" target = "_blank" rel = "noopener noreferrer" >
            ...
            </div><div className="col-md-4 bg-light"><h6 className="font-weight-bolder line-height">CONTACT INFORMATION</h6><p>moyaerika5@gmail.com</p></div>
             </div>
